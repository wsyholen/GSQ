package com.sixtyrobbers.GSQ.fourm.common.interceptor;
...
public class SqlCostInterceptor implements Interceptor {
    ...
    private final static Logger log = Logger.getLogger(SqlCostInterceptor.class);
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        try {
            ...
            log.info("SQL：[" + sql.trim() + "] 执行耗时 [" + sqlCost + "ms]");
        }
    }
    ...
    private boolean isPrimitiveOrPrimitiveWrapper(Class<?> parameterObjectClass) {
        return parameterObjectClass.isPrimitive() || (parameterObjectClass.isAssignableFrom(String.class) || parameterObjectClass.isAssignableFrom(Byte.class) || parameterObjectClass.isAssignableFrom(Short.class) || parameterObjectClass.isAssignableFrom(Integer.class)
                || parameterObjectClass.isAssignableFrom(Long.class) || parameterObjectClass.isAssignableFrom(Double.class) || parameterObjectClass.isAssignableFrom(Float.class) || parameterObjectClass.isAssignableFrom(Character.class) || parameterObjectClass.isAssignableFrom(Boolean.class));
    }
